...
<head>
  ...
  <title>Umiya Industries</title>
  <meta content="" name="description">
  <meta content="" name="keywords">
  <link rel="stylesheet" href="style.css">

  <!-- Favicons -->
  <link href="assets/img/umiya_faviicon.png" rel="icon">
  <link href="assets/img/umiya_faviicon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
   ...
   <a href = "index.php"><img src ="assets/img/umiyalogo.png"  width="30" heigh= "30"  id ="img1" ></a>
      <h1 class="logo mr-auto"><a href="index.php">Umiya Industries</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Better Solutions For frabrication  work </h1>
          <h2>We are team of talented   fabricater and making  agarabati powder  fillter machine, agarabati mixter  machine </h2>
          <div class="d-lg-flex">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="assets/img/site_fabriacation_erection_squ.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
